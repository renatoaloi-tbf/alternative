			...
			<WrapperCard>
				<Card>
					...
					<WrapperRecentNumbers>
						<RecentNumbers result="12.436L" description="Última coleta" />
						<RecentNumbers result="280.545L" description="Total Abril" />
						<RecentNumbers result="R$1.38/L" description="Março" />
					</WrapperRecentNumbers>
				</Card>
				<WrapperQuickMenu>
					<QuickMenuItem
